class AddEstadisticaJulio2010 < ActiveRecord::Migration
  def self.up
    ...
    " gross_salary > 3000 and gross_salary < 60000 and rubro_empresa <> 'IBM'  " +
    "  group by rubro_empresa    having count(*) > 15 "
    ...
    " gross_salary > 3000 and gross_salary < 60000 and cargo <> 'IBM' " + 
    " group by cargo having count(*) > 5 "
